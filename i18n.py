...
TEXTS = {
    "ja": {
        ...
        "nav_language": "言語",
        "nav_about": "このアプリについて",
        "about_tagline": "ADHDの集中を支えるデスクトップオーバーレイ",
        "about_version": "バージョン {ver}（コア {skel}）",
        "about_oss": "1/f はオープンソースプロジェクトです（MIT License）。",
        "about_operator": "現在の運営: {operator}",
        "about_credits": "クレジット",
        "about_credit_pooh": "くまのプーさん: A・A・ミルネ著／E・H・シェパード挿絵（パブリックドメイン）",
        "about_credit_weather": "天気情報: Open-Meteo / ip-api.com（無料・登録不要）",
        "about_credit_ui": "UI: PyQt5",
    ...
    "en": {
        ...
        "nav_about": "About",
        "about_tagline": "A desktop overlay that supports ADHD focus",
        "about_version": "Version {ver} (core {skel})",
        "about_oss": "1/f is an open-source project (MIT License).",
        "about_operator": "Currently operated by {operator}",
        "about_credits": "Credits",
        "about_credit_pooh": "Winnie-the-Pooh: by A.A. Milne, ill. E.H. Shepard (Public Domain)",
        "about_credit_weather": "Weather: Open-Meteo / ip-api.com (free, no signup)",
        "about_credit_ui": "UI: PyQt5",
