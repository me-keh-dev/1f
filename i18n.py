...
TEXTS = {
    "ja": {
        ...
        "mouse_fade": "マウス近接で透過",
        "fade_mode": "効き方",
        "fade_mode_around": "マウスの周囲を透過",
        "fade_mode_whole": "全体を透過",
        "fade_center": "中心",
        "fade_range": "範囲",
        "fade_alpha": "透過度",
        ...
        "about_credits": "クレジット",
        "about_credit_weather": "天気・位置情報: Open-Meteo / ipwho.is（無料・登録不要）",
    ...
    "en": {
        ...
        "about_credit_weather": "Weather & location: Open-Meteo / ipwho.is (free, no signup)",
        "about_credit_ui": "UI: PyQt5",
